...
from functions import VariationalAutoencoder, extract_tiles_with_offset, find_local_maxima, flood_fill_region, preprocess_tile
...
print(f"✓ Loaded NN scorer model from: {scorer_name} with threshold: {scorer_threshold:.3f} in mode: {scorer_mode}")
